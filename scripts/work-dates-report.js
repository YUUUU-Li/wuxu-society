...
function build() {
  ...
  out.push("   **未填者不猜日期**——统一排在已填者之后，作品库里另立「年份待考」一节（同时点/未填者之间按标识名字母序，见 `scripts/works-registry.js`）。");
  out.push("   ⚠️ 旧口径有两处已废弃：①「未填者继承前一篇已填作品的时点」——旧登记表 `fulltext_order.json` 开头即 2024-04-04 的清明雅集，");
  out.push("   30 多篇未填作品会被一律算作 2024-04-04（含 2026 年的投稿）挤作一堆；②三张共享登记表（groups/fulltext_order/pending_issue.json 已删除）——");
  out.push("   名单改为构建期从 `src/works` 推导，投稿 PR 只新增一个作品文件，不再互相冲突。");
  out.push("");
  out.push("## 二、已填创作时间");
  out.push("");
